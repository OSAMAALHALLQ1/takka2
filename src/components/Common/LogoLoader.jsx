...
// Shared timing constants — physically natural easeOutCubic curve.
...
const LogoLoader = () => {
  ...
  const logoClasses = `w-full h-auto drop-shadow-lg`;
  ...
  if (prefersReducedMotion) {
    return (
      <div className={containerClasses}>
        ...
        >
          <div className={logoClasses} role="img" aria-label="شعار تحميل تكة">
            <StaticLogo />
          </div>
          <div className={textClasses}>جاري التحميل...</div>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className={containerClasses}>
      ...
      >
        <div className={logoClasses} role="img" aria-label="شعار تحميل تكة — يد تضغط زراً أحمر">
          <svg
            viewBox="0 0 1085.6 1146.4"
            className="w-full h-auto"
            preserveAspectRatio="xMidYMid meet"
            aria-hidden="true"
          >
            {/* logoBackground — white rounded card (static) */}
            ...
            {/* redButton — pulses subtly when the hand touches it (static position) */}
            <motion.circle
            ...
            >
              ...
              />
              {/* Palm / main hand body (cls-3) — previously MISSING */}
              <path
                className="cls-3"
                fill="none"
                stroke="#262424"
 ...
 * Contains the COMPLETE hand (all 4 paths) so it renders correctly.
 */
const StaticLogo = () => (
  <svg
    viewBox="0 0 1085.6 1146.4"
