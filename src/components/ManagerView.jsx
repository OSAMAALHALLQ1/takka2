                ...
                <div key={bill.id} className="admin-card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <code className="num-font" style={{ fontSize: '0.85rem', background: 'var(--bg-surface-2)', padding: '2px 6px', borderRadius: '4px', color: 'var(--text-muted)' }}>{bill.id}</code>
                    </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', fontSize: '0.85rem' }}>
                    <div><span style={{ color: 'var(--text-muted)' }}>الوقت: </span><span className="num-font" style={{ fontWeight: 600 }}>{bill.timeFormatted}</span></div>
                    <div><span style={{ color: 'var(--text-muted)' }}>الكاشير: </span><span style={{ fontWeight: 600 }}>{bill.cashierCode}</span></div>
                    <div><span style={{ color: 'var(--text-muted)' }}>النادل: </span><span className="num-font" style={{ fontWeight: 600 }}>{bill.waiterCode}</span></div>
                  </div>

                  <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)', paddingTop: '8px', borderTop: '1px solid var(--border-light)' }}>
